...
TW_API typedef void (TW_CALL * TwSetVarCallback)(const void *value, void *clientData);
TW_API typedef void (TW_CALL * TwGetVarCallback)(void *value, void *clientData);
TW_API typedef void (TW_CALL * TwButtonCallback)(void *clientData);
